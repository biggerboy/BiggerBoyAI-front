...
const sendMessage = async () => {
  ...
  try {
    const response = await fetch(`http://localhost:8080/ai/generateStream?message=${encodeURIComponent(message)}&local=${useLocal.value}&web=${useWeb.value}`, {
      headers: {
